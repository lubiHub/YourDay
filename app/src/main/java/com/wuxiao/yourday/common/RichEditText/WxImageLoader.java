...
public class WxImageLoader {
	...
	private static WxImageLoader mInstance;
	 ...
	 * @return
	 */
	public static WxImageLoader getInstance() {

		if (mInstance == null) {
			synchronized (WxImageLoader.class) {
				if (mInstance == null) {
					mInstance = new WxImageLoader(1, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	private WxImageLoader(int threadCount, Type type) {
	 ...
	 * @return
	 */
	public static WxImageLoader getInstance(int threadCount, Type type) {

		if (mInstance == null) {
			synchronized (WxImageLoader.class) {
				if (mInstance == null) {
					mInstance = new WxImageLoader(threadCount, type);
				}
			}
		}
		return mInstance;
